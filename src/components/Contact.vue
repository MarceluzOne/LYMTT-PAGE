    ...
    <div class="contact-section__container">
      ...
      <div class="contact-section__form-wrapper">
        <form @submit.prevent="submitForm" class="contact-form">
          ...
          <input id="nome" v-model="formData.nome" type="text" class="form-input" required />

          <label class="form-label" for="assunto">Assunto</label>
          <input id="assunto" v-model="formData.assunto" type="text" class="form-input" required />

          <label class="form-label form-label--hint" for="mensagem">
            Envie sua ideia para que um de nossos especialistas entre em contato
          </label>
          <textarea id="mensagem" v-model="formData.mensagem" class="form-textarea" rows="5" required></textarea>
