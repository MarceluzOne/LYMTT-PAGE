...
const teamMembersData = [
  {
    ...
    description: 'Especialista em desenvolvimento Backend com Java e Spring Boot',
    photo: 'larissa.jpg'
  },
  {
    name: 'Yasmim Camille',
    role: 'Especialista em Qualidade (QA)',
    description: 'Apaixonada por interfaces, domina Angular, VueJS e a usabilidade (UX).',
    photo: 'yasmim.jpg'
  },
  {
    name: 'Marcelo Arruda',
  ...
  },
  {
    ...
    description: 'Garante a performance e segurança em todas as camadas de código.',
    photo: 'thialy.jpg'
  },
  {
    name: 'Thailan Sousa',
    role: 'Egenheiro de Software',
    description: 'Em fase de aprofundamento em PHP/Laravel, trazendo novas visões.',
    photo: 'thailan.jpg'
  }
];
    ...
    <div class="about-us-container">
      ...
      <div class="mission-block">
        <p class="mission-text">
          Nascemos da paixão por transformar processos complexos em soluções digitais elegantes e eficientes. Nossa missão é ser o parceiro tecnológico que impulsiona a inovação, garantindo que nossos clientes, operem com o máximo de performance e segurança.
        </p>
        <p class="mission-text">
          Acreditamos em código limpo, em metodologias ágeis e, acima de tudo, no poder da colaboração. Somos uma equipe enxuta, mas extremamente especializada, pronta para levar a sua visão do papel para o código.
        </p>
      </div>
